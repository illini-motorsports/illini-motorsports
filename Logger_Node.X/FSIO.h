...
#define MDD_WriteProtectState() 0
...
/*********************************************************************************
  ...
  Input:
    ...
    stream -            Pointer to file structure
    Buffer_x_Full -     Pointer to buffer full flag of the buffer that was sent
  Return:
    size_t - number of units written
  Side Effects:
    The FSerrno variable will be changed.
    The buffer full flag will be set when writing to the data buffer is complete.
  Description:
