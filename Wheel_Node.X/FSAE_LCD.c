...
void initAllScreens(void){
	...
	initScreenItem(&pdmDrawItems[0], 0, 50, 20, redrawDigit, &pdmCurrentDraw);
	initScreenItem(&pdmDrawItems[1], 50, 50, 20, redrawDigit, &pdmIGNdraw);
	initScreenItem(&pdmDrawItems[2], 100, 50, 20, redrawDigit, &pdmINJdraw);
	initScreenItem(&pdmDrawItems[3], 150, 50, 20, redrawDigit, &pdmFUELdraw);
	initScreenItem(&pdmDrawItems[4], 200, 50, 20, redrawDigit, &pdmECUdraw);
	initScreenItem(&pdmDrawItems[5], 250, 50, 20, redrawDigit, &pdmWTRdraw);
	initScreenItem(&pdmDrawItems[6], 300, 50, 20, redrawDigit, &pdmFANdraw);
	initScreenItem(&pdmDrawItems[7], 350, 50, 20, redrawDigit, &pdmAUXdraw);
	initScreenItem(&pdmDrawItems[8], 0, 125, 20, redrawDigit, &pdmPDLUdraw);
	initScreenItem(&pdmDrawItems[9], 50, 125, 20, redrawDigit, &pdmPDLDdraw);
	initScreenItem(&pdmDrawItems[10], 100, 125, 20, redrawDigit, &pdm5v5draw);
	initScreenItem(&pdmDrawItems[11], 150, 125, 20, redrawDigit, &pdmBATdraw);
	initScreenItem(&pdmDrawItems[12], 200, 125, 20, redrawDigit, &pdmSTR0draw);
	initScreenItem(&pdmDrawItems[13], 250, 125, 20, redrawDigit, &pdmSTR1draw);
	initScreenItem(&pdmDrawItems[14], 300, 125, 20, redrawDigit, &pdmSTR2draw);
	initScreenItem(&pdmDrawItems[15], 350, 125, 20, redrawDigit, &pdmSTRdraw);
	initScreenItem(&pdmDrawItems[16], 0, 225, 20, redrawDigit, &pdmFUELPcut);
	initScreenItem(&pdmDrawItems[17], 50, 225, 20, redrawDigit, &pdmECUPcut);
	initScreenItem(&pdmDrawItems[18], 100, 225, 20, redrawDigit, &pdmWTRPcut);
	initScreenItem(&pdmDrawItems[19], 150, 225, 20, redrawDigit, &pdmFANPcut);
	
	allScreens[PDM_CUT_SCREEN] = &pdmCutScreen;
	pdmCutScreen.items = pdmCutItems;
	pdmCutScreen.len = 21;
	initScreenItem(&pdmCutItems[0], 0, 50, 20, redrawDigit, &pdmTemp);
	initScreenItem(&pdmCutItems[1], 50, 50, 20, redrawDigit, &pdmICTemp);
	initScreenItem(&pdmCutItems[2], 100, 50, 20, redrawDigit, &pdmVBat);
	initScreenItem(&pdmCutItems[3], 150, 50, 20, redrawDigit, &pdm12v);
	initScreenItem(&pdmCutItems[4], 200, 50, 20, redrawDigit, &pdm5v5);
	initScreenItem(&pdmCutItems[5], 250, 50, 20, redrawDigit, &pdm5v);
	initScreenItem(&pdmCutItems[6], 300, 50, 20, redrawDigit, &pdm3v3);
	initScreenItem(&pdmCutItems[7], 350, 50, 20, redrawDigit, &pdmIGNcut);
	initScreenItem(&pdmCutItems[8], 0, 125, 20, redrawDigit, &pdmINJcut);
	initScreenItem(&pdmCutItems[9], 50, 125, 20, redrawDigit, &pdmFUELNcut);
	initScreenItem(&pdmCutItems[10], 100, 125, 20, redrawDigit, &pdmECUNcut);
	initScreenItem(&pdmCutItems[11], 150, 125, 20, redrawDigit, &pdmWTRNcut);
	initScreenItem(&pdmCutItems[12], 200, 125, 20, redrawDigit, &pdmFANNcut);
	initScreenItem(&pdmCutItems[13], 250, 125, 20, redrawDigit, &pdmAUXcut);
	initScreenItem(&pdmCutItems[14], 300, 125, 20, redrawDigit, &pdmPDLUcut);
	initScreenItem(&pdmCutItems[15], 350, 125, 20, redrawDigit, &pdmPDLDcut);
	initScreenItem(&pdmCutItems[16], 0, 225, 20, redrawDigit, &pdm5v5cut);
	initScreenItem(&pdmCutItems[17], 50, 225, 20, redrawDigit, &pdmBATcut);
	initScreenItem(&pdmCutItems[18], 100, 225, 20, redrawDigit, &pdmSTR0cut);
	initScreenItem(&pdmCutItems[19], 150, 225, 20, redrawDigit, &pdmSTR1cut);
	initScreenItem(&pdmCutItems[20], 200, 225, 20, redrawDigit, &pdmSTR2cut);
...
void initScreen(uint8_t num){
	switch(num){
		...
		case PDM_DRAW_SCREEN:
			...
			textSetCursor(50, 30);
			textWrite("IGN D");
			textSetCursor(100, 30);
			textWrite("INJ D");
			textSetCursor(150, 30);
			textWrite("FUEL D");
			textSetCursor(200, 30);
			textWrite("ECU D");
			textSetCursor(250, 30);
			textWrite("WTR D");
			textSetCursor(300, 30);
			textWrite("FAN D");
			textSetCursor(350, 30);
			textWrite("AUX D");
			textSetCursor(0,100);
			textWrite("PDLU D");
			textSetCursor(50, 100);
			textWrite("PDLD D");
			textSetCursor(100, 100);
			textWrite("5V5 D");
			textSetCursor(150, 100);
			textWrite("BAT D");
			textSetCursor(200, 100);
			textWrite("STR0 D");
			textSetCursor(250, 100);
			textWrite("STR1 D");
			textSetCursor(300, 100);
			textWrite("STR2 D");
			textSetCursor(350,100);
			textWrite("STR D");
			textSetCursor(0, 200);
			textWrite("FUEL PC");
