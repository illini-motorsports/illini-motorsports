...
//does same thing as set_en_load but we call it after the soft start is done. This is the final state. Dont call this here
void set_load_pwm(uint8_t load_idx, uint8_t load_state) {
    switch (load_idx) {
