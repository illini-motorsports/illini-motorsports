...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Analog_Node.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/CANHub.o: CANHub.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -DHUB -I"../ECAN.X" -ms -oa- -Ou- -Ot- -Ob- -Op- -Or- -Od- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/CANHub.o   CANHub.c 
...
${OBJECTDIR}/_ext/2123637668/ECAN.o: ../ECAN.X/ECAN.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -DHUB -I"../ECAN.X" -ms -oa- -Ou- -Ot- -Ob- -Op- -Or- -Od- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/2123637668/ECAN.o   ../ECAN.X/ECAN.c 
...
${OBJECTDIR}/CANHub.o: CANHub.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/CANHub.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DHUB -I"../ECAN.X" -ms -oa- -Ou- -Ot- -Ob- -Op- -Or- -Od- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/CANHub.o   CANHub.c 
	@${DEP_GEN} -d ${OBJECTDIR}/CANHub.o 
	@${FIXDEPS} "${OBJECTDIR}/CANHub.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/2123637668/ECAN.o: ../ECAN.X/ECAN.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/2123637668 
	@${RM} ${OBJECTDIR}/_ext/2123637668/ECAN.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DHUB -I"../ECAN.X" -ms -oa- -Ou- -Ot- -Ob- -Op- -Or- -Od- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/2123637668/ECAN.o   ../ECAN.X/ECAN.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/2123637668/ECAN.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/2123637668/ECAN.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
