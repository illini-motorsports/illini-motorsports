/******************************************************************************
 *
 *              ECAN C Library Source Code Header
 *
 ******************************************************************************
 * FileName:        ECAN.h
 * Dependencies:    ECAN_logging_<insert relevant name>.h,
 *					p18F46K80.h and
 *					GenericTypeDefs.h
...
// 02/15/13 - changed PIR3 defines to PIR5
//          - changed COMSTAT_FIFOEMPTY to COMSTAT_NOT_FIFOEMPTY
// 03/08/13 - addded define to control which configuration header to include
//
//
...
#elif HUB
#ifdef MOTEC_RESEND
#include "ECAN_hub_config_motec.h"
#else
 ...
 *                  options defined in ECAN_config.h file.
 *                  You may manually edit ECAN_config.h file as per your
 ...
 *
 ********************************************************************/
BOOL ECANSendMessage(const unsigned long id,
                     BYTE *data,
                     const BYTE dataLen,
                     ECAN_TX_MSG_FLAGS msgFlags);
...
/*********************************************************************
 * Macro:           ECANSetClockSourceMode(mode)
 *
 * Overview:        Use this Macro to set the source of the clock used
 *                  for the ECAN system clock
 *
 * PreCondition:    None
 *
 * Input:           mode        - Clock mode
 *                                Allowable values are
 *                    ECAN_CLOCK_MODE_DEFAULT
 *                      - oscillator is the source
 *                    ECAN_CLOCK_MODE_PLL
 *                      - PLL output is the source
 *
 * Output:          None
 *
 * Side Effects:
 *
 ********************************************************************/
#define ECANSetCLKSELMode(mode)      CIOCON_CLKSEL = mode

    #define ECAN_CLOCK_MODE_DEFAULT 1
    #define ECAN_CLOCK_MODE_PLL     0
...
#define FOUR 0
    ...
    #define COMSTAT_NOT_FIFOEMPTY   COMSTATbits.NOT_FIFOEMPTY
    ...
    #define CIOCON_CLKSEL           CIOCONbits.CLKSEL

    #define PIR5_RXBnIF             PIR5bits.RXBnIF
    #define PIR5_RXB0IF             PIR5bits.RXB0IF
    #define PIR5_RXB1IF             PIR5bits.RXB1IF
    #define PIR5_IRXIF              PIR5bits.IRXIF
    #define PIR5_FIFOWMIF           PIR5bits.FIFOWMIF
    ...
    #define PIR5_RXBnIF             RXB1IF
    #define PIR5_IRXIF              IRXIF
    #define PIR5_RXB0IF             RXB0IF
    #define PIR5_RXB1IF             RXB1IF
